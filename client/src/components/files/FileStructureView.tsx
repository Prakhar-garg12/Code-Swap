...
function FileStructureView() {
    ...
    return (
        <div onClick={handleClickOutside} className="flex flex-col flex-grow bg-[#0F1624] text-white p-4 rounded-lg shadow-lg">
    {/* Header */}
    <div className="flex justify-between items-center border-b border-gray-600 pb-2">
        <h2 className="text-xl font-bold text-blue-300">Files</h2>
        <div className="flex gap-2">
            <button
                className="rounded-md p-1 bg-gray-700 hover:bg-gray-600 transition"
    ...
    {/* File Explorer - Chat Style */}
    <div
        className={cn(
            "flex-grow overflow-auto space-y-2 p-2",
            {
    ...
    >
        {sortedFileStructure.children && sortedFileStructure.children.length > 0 ? (
            ...
            <div className="text-center text-gray-300 mt-4">No files found. Start by adding one!</div>
        )}
    </div>
</div>
